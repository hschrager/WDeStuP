"""
This script is called by the plugin-wrapper, ReachAllPlaces.js, which passes down the
...
from ReachAllPlaces import ReachAllPlaces
...
plugin = ReachAllPlaces(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
